...
const theme = {
  "base": "pb-[20px] text-description *:first:mt-0 *:last:mb-0 *:my-[6px]"
};
const _sfc_main = {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@bitrix24/b24ui-nuxt/dist/runtime/components/prose/AccordionItem.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=AccordionItem-YywEPBPv.mjs.map
