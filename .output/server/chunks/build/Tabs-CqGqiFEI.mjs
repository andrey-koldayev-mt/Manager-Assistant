...
import { p as useComponentProps, u as useAppConfig, n as tv, t as transformUI, s as useForwardProps, h as get, e as _sfc_main$f, c as _sfc_main$6 } from './server.mjs';
import { c as TabsRoot_default, b as TabsList_default, a as TabsIndicator_default, d as TabsTrigger_default, T as TabsContent_default } from './TabsTrigger-CZpw1vvP.mjs';
...
import './useId-D2CyCh8B.mjs';
import './useDirection-BoRtQb0A.mjs';
                          ...
                          return [
                            renderSlot(_ctx.$slots, "leading", {
                              ...
                              item.icon ? (openBlock(), createBlock(resolveDynamicComponent(item.icon), {
                                ...
                                "data-slot": "leadingIcon",
                                class: b24ui.value.leadingIcon({ class: [unref(props).b24ui?.leadingIcon, item.b24ui?.leadingIcon] })
                              }, null, 8, ["class"])) : item.avatar ? (openBlock(), createBlock(_sfc_main$f, mergeProps({
                                key: 1,
                                size: item.b24ui?.leadingAvatarSize || unref(props).b24ui?.leadingAvatarSize || b24ui.value.leadingAvatarSize()
                              }, { ref_for: true }, item.avatar, {
                                "data-slot": "leadingAvatar",
...
//# sourceMappingURL=Tabs-CqGqiFEI.mjs.map
