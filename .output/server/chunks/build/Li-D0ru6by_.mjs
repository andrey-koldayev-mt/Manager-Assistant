...
const theme = {
  "slots": {
    "base": "my-1.5 ps-1.5 leading-relaxed [&>ul]:my-0 [&>ol]:my-0 text-label"
  }
};
const _sfc_main = {
  __name: "ProseLi",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@bitrix24/b24ui-nuxt/dist/runtime/components/prose/Li.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Li-D0ru6by_.mjs.map
