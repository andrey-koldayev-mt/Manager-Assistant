...
import { o as useComponentProps, u as useAppConfig, m as tv, l as resolveIcon, b as _sfc_main$i, j as icons } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(props).to) {
        _push(ssrRenderComponent(_sfc_main$i, mergeProps({ to: unref(props).to, target: target.value, ..._ctx.$attrs }, {
...
//# sourceMappingURL=Callout-mw6EzPrW.mjs.map
