...
const theme = {
  "slots": {
    "base": "list-decimal ps-2 mb-2 ms-3 marker:text-label text-label"
  }
};
const _sfc_main = {
  __name: "ProseOl",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/@bitrix24/b24ui-nuxt/dist/runtime/components/prose/Ol.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Ol-Ba0DeGZz.mjs.map
