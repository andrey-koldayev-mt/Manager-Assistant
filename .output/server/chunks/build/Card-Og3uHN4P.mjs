...
import { p as useComponentProps, u as useAppConfig, n as tv, b as _sfc_main$d, j as icons } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(props).to) {
        _push(ssrRenderComponent(_sfc_main$d, mergeProps({ "aria-label": ariaLabel.value }, { to: unref(props).to, target: target.value, ..._ctx.$attrs }, {
...
//# sourceMappingURL=Card-Og3uHN4P.mjs.map
