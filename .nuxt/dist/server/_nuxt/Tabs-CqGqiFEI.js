import { useSlots, computed, ref, unref, mergeProps, withCtx, createVNode, resolveDynamicComponent, renderSlot, openBlock, createBlock, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext, useModel, mergeModels } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrRenderVNode, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
import { p as useComponentProps, u as useAppConfig, s as useForwardProps, n as tv, h as get, e as _sfc_main$2, c as _sfc_main$3, t as transformUI } from "../server.mjs";
                          ...
                          return [
                            renderSlot(_ctx.$slots, "leading", {
                              ...
                              item.icon ? (openBlock(), createBlock(resolveDynamicComponent(item.icon), {
                                ...
                                "data-slot": "leadingIcon",
                                class: b24ui.value.leadingIcon({ class: [unref(props).b24ui?.leadingIcon, item.b24ui?.leadingIcon] })
                              }, null, 8, ["class"])) : item.avatar ? (openBlock(), createBlock(_sfc_main$2, mergeProps({
                                key: 1,
                                size: item.b24ui?.leadingAvatarSize || unref(props).b24ui?.leadingAvatarSize || b24ui.value.leadingAvatarSize()
                              }, { ref_for: true }, item.avatar, {
                                "data-slot": "leadingAvatar",
...
//# sourceMappingURL=Tabs-CqGqiFEI.js.map
