import { computed, defineComponent, toRefs, openBlock, createBlock, unref, withCtx, renderSlot, withKeys, useSlots, mergeProps, createVNode, resolveDynamicComponent, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext, ref } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderSlot, ssrRenderVNode, ssrRenderClass, ssrInterpolate } from "vue/server-renderer";
import { l as isNullish, q as useForwardExpose, a as Primitive, f as createContext, p as useComponentProps, u as useAppConfig, s as useForwardProps, n as tv, h as get, j as icons, t as transformUI } from "../server.mjs";
import { u as useDirection } from "./useDirection-BoRtQb0A.js";
import { isEqual } from "C:/Users/andrey.koldayev/PortableGit/Manager-Assistant/node_modules/ohash/dist/index.mjs";
import { useVModel, reactivePick } from "@vueuse/core";
import { a as CollapsibleRoot_default, C as CollapsibleContent_default, b as CollapsibleTrigger_default } from "./CollapsibleTrigger-DLJpxN5O.js";
import { u as useId } from "./useId-D2CyCh8B.js";
...
//# sourceMappingURL=Accordion-C5E8YLSs.js.map
