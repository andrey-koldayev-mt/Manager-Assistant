...
export default {
  "slots": {
    "root": "flex flex-col min-h-0 min-w-0 divide-y divide-(--ui-color-divider-default)",
    "input": "",
    "close": "",
    ...
    "group": "p-1 isolate",
    "empty": "text-center text-description",
    "label": "text-label",
    "item": "group relative w-full flex items-center select-none outline-none before:absolute before:z-[-1] before:inset-px before:rounded-(--ui-border-radius-sm) data-disabled:cursor-not-allowed data-disabled:opacity-30",
    ...
    "itemTrailingHighlightedIcon": "shrink-0 text-label hidden group-data-highlighted:inline-flex",
  ...
  "variants": {
    ...
    "active": {
      ...
      "false": {
        "item": "text-legend data-highlighted:not-data-disabled:text-legend data-highlighted:not-data-disabled:before:bg-(--ui-color-bg-content-secondary) transition-colors before:transition-colors",
        "itemLeadingIcon": "text-legend group-data-highlighted:not-group-data-disabled:text-legend transition-colors"
      }
    },
    "loading": {
      "true": {
