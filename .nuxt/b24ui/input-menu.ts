...
export default {
  "slots": {
    ...
    "base": "w-full py-0 border-0 focus:outline-none disabled:cursor-not-allowed disabled:pointer-events-auto disabled:select-none disabled:opacity-30 disabled:resize-none appearance-none transition-colors duration-300 ease-linear text-(--ui-color-base-1) style-blurred-bg-input hover:text-(--ui-color-base-1) focus:text-(--ui-color-base-1) active:text-(--ui-color-base-1) placeholder:text-(--ui-color-design-plain-na-content-secondary) font-[family-name:var(--ui-font-family-primary)] font-(--ui-font-weight-regular) align-middle",
    ...
    "viewport": "relative scroll-py-1 w-60 max-h-[40vh] overflow-x-hidden overflow-y-auto scrollbar-thin",
    "arrow": "fill-(--ui-color-bg-content-primary)",
    "group": "grid",
    "empty": "h-(--popup-window-delimiter-section-height) py-2 select-none outline-none whitespace-nowrap text-center text-(length:--ui-size-sm)/(--ui-font-line-height-lg) text-legend font-(--ui-font-weight-normal)",
    ...
    "item": "group w-full min-w-[195px] h-[36px] px-4.5 mt-(--menu-item-block-stack-space) relative flex flex-row rtl:flex-row-reverse items-center select-none outline-none whitespace-nowrap cursor-pointer data-disabled:cursor-not-allowed data-disabled:opacity-30 data-disabled:select-none text-start text-(length:--ui-font-size-md) text-legend hover:text-label data-highlighted:not-data-disabled:text-label data-[state=open]:text-label data-[state=checked]:text-label hover:bg-(--ui-color-base-black-fixed)/3 dark:hover:bg-(--ui-color-base-black-fixed) active:bg-(--ui-color-base-black-fixed)/6 dark:active:bg-(--ui-color-base-black-fixed) data-highlighted:not-active:bg-(--ui-color-base-black-fixed)/3 dark:data-highlighted:not-active:bg-(--ui-color-base-black-fixed) data-[state=open]:bg-(--ui-color-base-black-fixed)/6 dark:data-[state=open]:bg-(--ui-color-base-black-fixed) transition-colors",
    "itemLeadingIcon": "size-[25px] shrink-0 text-(--ui-color-base-5) group-data-highlighted:not-data-disabled:text-(--ui-color-accent-main-primary) group-data-[state=open]:text-(--ui-color-accent-main-primary) group-data-[state=checked]:text-(--ui-color-accent-main-primary)",
    ...
    "tagsItemDelete": "cursor-pointer inline-flex items-center disabled:cursor-not-allowed disabled:pointer-events-auto text-(--b24ui-icon-color-secondary) hover:text-(--b24ui-icon-color-secondary-hover) transition-none",
    "tagsItemDeleteIcon": "",
    "tagsInput": ""
  },
  "variants": {
    ...
    "addNew": {
      "true": {
        "group": "",
        "item": "text-legend data-highlighted:not-data-disabled:text-label data-[state=checked]:text-label",
    ...
    "multiple": {
      "true": {
        ...
        "tagsInput": "flex-1 border-0 bg-transparent ps-[6px] pe-[0px] py-0 placeholder:text-(--ui-color-design-plain-na-content-secondary) focus:outline-none disabled:cursor-not-allowed disabled:pointer-events-auto disabled:select-none disabled:opacity-30 focus:ring-0 focus-visible:ring-0"
      },
      "false": {
        "base": "px-3 placeholder:text-(--ui-color-design-plain-na-content-secondary) focus:outline-none disabled:cursor-not-allowed disabled:pointer-events-auto disabled:select-none disabled:opacity-30"
      }
    },
    "colorItem": {
      "air-primary": {
